...
Gui, Add, Text, x12 y69 w70 h20 , Project Name
Gui, Add, Edit, x92 y69 w300 h20 vProjectName,

Gui, Add, Text, x12 y99 w70 h20 , Project Desc
Gui, Add, Edit, x92 y99 w300 h20 vProjectDescription, 

Gui, Add, Text, x12 y129 w70 h20 , Install guide
Gui, Add, Edit, x92 y129 w300 h50 vInstallGuide,

Gui, Add, Text, x12 y189 w70 h20 , Featurelist
Gui, Add, Edit, x92 y189 w300 h70 vFeatureList,

Gui, Add, Text, x12 y269 w70 h20 , Usage Guide
Gui, Add, Edit, x92 y269 w300 h50 vUsageGuide,

Gui, Add, Button, x12 y325 w381 h30 gExport, Export
Gui, Show, x127 y87 h362 w406, Readme.MD generator
...
o.="`n - Facebook at <a href=" chr(34) "https://www.facebook.com/" chr(34) " target=" chr(34) "_blank" chr(34) ">`Facebook`</a>"
